...
{
	$type=-1;
	echo "<h3><center> Problème de Minimisation </center></h3>";
}else
{
	$type=1;
	echo "<h3><center> Problème de Maximisation </center></h3>";
}
...
{
	echo "<center>Probleme de Simplexe de 2 phases</center> ";
	$tab[$m+1][0]="Coût";
...
//Phase 2
	...
	{    
	    echo "<br/><br/>";
		echo '<h3><p style="color: red;">Problème non réalisable</p></h3>';
	}
...
<script type="text/javascript" src="./source/html2canvas.js"></script>
<script type="text/javascript" src="./source/jspdf.debug.js"></script>
<script type="text/javascript" src="./source/jquery-git.js"></script>
...
$('#pdfview').click(function () {
     pdf.addHTML(document.getElementById('pdfdiv'), 0, 50, function() {
  	pdf.save('simplexe.pdf');
	});
});
